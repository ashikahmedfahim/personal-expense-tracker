...
import { getCurrentMonthUtcRange, getMonthUtcRange, getUtcDateKeysForMonth, normalizeToMonthStartUtc, formatUtcDateKey, formatUtcMonthKey } from './date.js';
...
describe('formatUtcMonthKey', () => {
  it('formats a UTC date as YYYY-MM', () => {
    expect(formatUtcMonthKey(new Date('2024-06-15T12:00:00.000Z'))).toBe('2024-06');
  });
});
